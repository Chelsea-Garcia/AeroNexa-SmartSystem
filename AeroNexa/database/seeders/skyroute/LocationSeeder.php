    ...
    public function run(): void
    {
        $structure = [
            ...
            'China' => [
                ...
                'North China' => ['Beijing', 'Chengdu', 'Tianjin'],
            ],
            ...
            'Thailand' => [
                'Central' => ['Bangkok', 'Nonthaburi', 'Ayutthaya'],
                'Northern' => ['Chiang Mai', 'Chiang Rai', 'Lampang'],
                'Eastern' => ['Pattaya', 'Chonburi', 'Rayong'],
            ],

            'Malaysia' => [
                'Klang Valley' => ['Kuala Lumpur', 'Petaling Jaya', 'Shah Alam'],
                'Northern Region' => ['Penang', 'Ipoh', 'Alor Setar'],
                'Southern Region' => ['Johor Bahru', 'Batu Pahat', 'Kluang'],
            ],

            'India' => [
                'North India' => ['Delhi', 'Jaipur', 'Chandigarh'],
                'West India' => ['Mumbai', 'Pune', 'Ahmedabad'],
                'South India' => ['Bangalore', 'Hyderabad', 'Chennai'],
            ],

            'Taiwan' => [
                'Northern Taiwan' => ['Taipei', 'Keelung', 'New Taipei'],
                'Central Taiwan' => ['Taichung', 'Changhua', 'Miaoli'],
            ],
            ...
            'UAE' => [
                'Dubai Emirate' => ['Dubai', 'Hatta', 'Jebel Ali'],
                'Abu Dhabi Emirate' => ['Abu Dhabi', 'Al Ain', 'Madinat Zayed'],
            ],

            'United Kingdom' => [
                'London Region' => ['London', 'Croydon', 'Westminster'],
                'Northwest England' => ['Manchester', 'Liverpool', 'Blackpool'],
            ],
            ...
            'Germany' => [
                ...
                'Berlin Region' => ['Berlin', 'Potsdam', 'Oranienburg'],
            ],
            ...
            'Switzerland' => [
                'Zurich Canton' => ['Zurich', 'Winterthur', 'Uster'],
                'Geneva Canton' => ['Geneva', 'Carouge', 'Meyrin'],
            ],

            'Türkiye' => [
                'Marmara Region' => ['Istanbul', 'Bursa', 'Izmit'],
            ...
            'Mexico' => [
                'Mexico City Region' => ['Mexico City', 'Ecatepec', 'Coyoacán'],
                'Jalisco' => ['Guadalajara', 'Zapopan', 'Tlaquepaque'],
                'Nuevo León' => ['Monterrey', 'Guadalupe', 'San Nicolás'],
            ],

            'South Africa' => [
                'Gauteng' => ['Johannesburg', 'Pretoria', 'Benoni'],
                'Western Cape' => ['Cape Town', 'Stellenbosch', 'Paarl'],
                'KwaZulu-Natal' => ['Durban', 'Pietermaritzburg', 'Umhlanga'],
            ],

            'Egypt' => [
                'Cairo Governorate' => ['Cairo', 'Nasr City', 'Heliopolis'],
                'Giza Governorate' => ['Giza', '6th of October', 'Sheikh Zayed'],
            ],
            ...
            'Ethiopia' => [
                'Addis Ababa Region' => ['Addis Ababa', 'Arada', 'Bole'],
            ],

            'Kenya' => [
                'Nairobi County' => ['Nairobi', 'Karen', 'Westlands'],
                'Coast Province' => ['Mombasa', 'Malindi', 'Lamu'],
            ],

            'Nigeria' => [
                'Lagos State' => ['Lagos', 'Ikeja', 'Ikorodu'],
                'Federal Capital Territory' => ['Abuja', 'Gwagwalada', 'Lugbe'],
            ],

            'Brazil' => [
                'São Paulo State' => ['São Paulo', 'Campinas', 'Santos'],
                'Rio de Janeiro State' => ['Rio de Janeiro', 'Niteroi', 'Petrópolis'],
                'Federal District' => ['Brasilia', 'Gama', 'Taguatinga'],
            ],

            'Argentina' => [
                'Buenos Aires Province' => ['Buenos Aires', 'La Plata', 'Mar del Plata'],
                'Córdoba Province' => ['Cordoba', 'Villa Carlos Paz', 'Río Cuarto'],
            ],
            ...
            'Peru' => [
                'Lima Province' => ['Lima', 'Callao', 'Miraflores'],
            ],

            'Colombia' => [
                'Capital District' => ['Bogotá', 'Engativá', 'Suba'],
            ...
            'New Zealand' => [
                'Auckland Region' => ['Auckland', 'Manukau', 'Waitakere'],
